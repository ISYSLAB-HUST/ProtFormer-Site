...
def prepare_protein_data(protein_labels, protein_name, protein_seq):
    ...
    protein_name_seq = [(protein_name[i], protein_seq[i]) for i in range(len(protein_name))]

    return protein_labels, protein_name_seq
